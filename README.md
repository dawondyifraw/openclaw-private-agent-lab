...
## 4. Model Strategy
The default provider order is Gemini-first across agents, with cloud fallbacks before local fallback.

- **Primary**: Google Gemini (`gemini-2.5-flash`)
- **Gemini fallback**: Google Gemini (`gemini-2.0-flash`)
- **Next fallback**: Groq (`llama-3.3-70b-versatile`)
- **Then**: OpenRouter (`google/gemini-2.0-flash-001`)
- **Last resort**: Local Ollama model per agent
