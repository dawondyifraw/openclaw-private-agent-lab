...
- Canonical workspace root: `/home/devbox/.openclaw/workspaces`
- `workspaces/` is runtime scratch only. No docs, policies, or legacy markers live inside it.
- Workspace documentation lives under: `docs/workspaces/`

Recommended runtime subfolders (optional, created lazily):
- `artifacts/`
- `scratch/`
- `outputs/`
...
4. Legacy contents preserved (non-destructive):
   - Previous contents of `/home/devbox/.openclaw/workspace/` were moved out of the live tree into the cold archive:
     - `/home/devbox/archives/openclaw_legacy_2026-02-10/workspace_legacy/_legacy_workspace_backup/`
